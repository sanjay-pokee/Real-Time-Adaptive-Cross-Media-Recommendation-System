...
% ---------------------------------------------------------------------
\begin{frame}[shrink=15]{2. Retrieval --- Hybrid Lexical and Semantic}
...
\column{0.485\textwidth}
\begin{center}
\shot{age-child}{width=\linewidth,height=4.5cm,keepaspectratio}%
...
\column{0.485\textwidth}
\begin{center}
\shot{age-adult}{width=\linewidth,height=4.5cm,keepaspectratio}%
