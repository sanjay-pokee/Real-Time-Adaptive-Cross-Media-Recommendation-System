...
export default function ScoreBars({ score, semantic_score, graph_score, ema_score, kg_score, profile_score }) {
  return (
    <div className="mt-4 flex flex-col gap-2.5 border-t border-slate-100 pt-4">
      ...
      <ScoreBar label="KG" value={kg_score} color="#0891B2" delay={320} missingText="No KG signal" />
      <ScoreBar label="Profile" value={profile_score} color="#DB2777" delay={400} missingText="No profile signal" />
    </div>
  );
}
