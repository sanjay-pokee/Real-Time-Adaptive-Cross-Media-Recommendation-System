...
\node[offb] (o2) at (13.40,5.65) {\texttt{preprocessing.}\\\texttt{build\_content\_catalog}\\unified 19-column schema};
...
\begin{table}
    ...
    \begin{tabular}{p{1.95cm} p{6.75cm} p{1.45cm} c}
        ...
        \midrule
        Data pipeline & \textbf{4 domains / 6 content types} normalised into one 19-column catalog: \textbf{106{,}332} items (28{,}352 music / 22{,}116 movies / 20{,}000 health / 20{,}000 industrial / 15{,}139 books / 725 finance) & \texttt{content\_catalog.csv} & \sOK \\
